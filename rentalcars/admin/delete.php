    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          ...
          <li><a href="add_car.php" class="text-white">Add car</a></li>
...
<form method= "post">
  ...
  <div class="mb-3">
    <label for="Inputid1" class="form-label">Car Id</label>
    <input type="number" class="form-control" name="carid" required>
  </div>

  
  
  
  <button type="submit"  name="valide" class="btn btn-primary">delete car</button>
</form>
...
if(isset($_POST['valide']))
{
    ...
    {
        if(!empty($_POST['carid']) AND is_numeric($_POST['carid']) )
        {
            
            $carid = htmlspecialchars(strip_tags($_POST['carid']));
